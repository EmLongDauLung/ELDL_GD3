        ...
        <div class="noidung m-5">
            <table class="table table-striped table-bordered border border-2">
                ...
                ?>
                        ...
                        <td><p><?php echo $row['oldprice'] ?></p></td>
                        <td><p><?php echo $row['price'] ?></p></td>
                        <td><p><?php echo $row['star'] ?></p></td>
                        <td><p><?php echo $row['type'] ?></p></td>
                        <td><p><?php echo $row['trademark_id'] ?></p></td>
                        <td><img src='../../assets/img/<?php echo $row['image'] ?>' height=100></td>
                        <td>
                            <form action="productEdit.php" method="POST">
                                <button type="submit" name="btn_optionEdit" value="<?php echo $row['product_id'] ?>">Sửa</button> 
                            </form>
                        </td>
                        <td>
